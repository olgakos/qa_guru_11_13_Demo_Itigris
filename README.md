...
- [х] Поиск 1 товара
- [х] Поиск нескольких товаров. Проверка результатов запроса (2)
...
Шаги:
1. <i>Зарегистрированным</i> пользователем перейти на страницу сборки проекта по ссылке: <a target="_blank" href="https://jenkins.autotests.cloud/job/Students/job/qa_guru_11_13_Demo_Itigris/">Jenkins Itigris</a>
